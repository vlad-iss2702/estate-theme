...
function twentysixteen_scripts() {
	...
	wp_enqueue_style( 'my-style', get_template_directory_uri() . '/css/my-style.css', '20220524' );
	
	wp_enqueue_style( 'bootstrap', 'https://cdn.jsdelivr.net/npm/bootstrap@5.1.3/dist/css/bootstrap.min.css', '20220524' );
...
add_action('init', 'estate');
	function estate() {
		$labels = array(
		    ...
		    'not_found' =>  'Недвижимость не найдено',
	...
	add_action( 'init', 'create_estate_taxonomies', 0 );
	function create_estate_taxonomies(){
	  $labels = array(
	    'name' => _x( 'Тип недвижимости', 'taxonomy general name' ),
	    'singular_name' => _x( 'Тип недвижимости', 'taxonomy singular name' ),
	    'search_items' =>  __( 'Найти категорию недвижимости' ),
	    'all_items' => __( 'Все категории недвижимости' ),
	    'parent_item' => __( 'Родительская категория недвижимости' ),
	  ...
	  register_taxonomy('estates', array('estate'), array(
	    'hierarchical' => true,
	    'labels' => $labels,
	    'show_ui' => true,
	    'query_var' => true,
